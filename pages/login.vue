<template>
  <div class="sign">
    <div class="logo"><a href="/"><img src="/header/logo.png" alt="LOGO" width="100"></a></div>
    <div class="main">
      <h4 class="title">
        <div class="normal-title">
          <nuxt-link to="/login"><span class="active">登陆</span></nuxt-link>
          <b>·</b>
          <nuxt-link :to="{path:'/register'}"><span>注册</span></nuxt-link>
        </div>
      </h4>
